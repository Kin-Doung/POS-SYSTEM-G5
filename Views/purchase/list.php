...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/style/purchase.css"> <!-- Adjust the path as needed -->
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <div class="button-category" style="display: flex; align-items: center; justify-content: space-around; padding: 10px;">
                                    <h6 class="text-white text-capitalize" style="margin: 0;">
                                        <select class="form-select text-white text-capitalize bg-dark border-0" aria-label="" style="background-color: #343a40; color: white; border: none;">
                                    ...
                                    <h6 class="text-white text-capitalize" style="margin: 0;"><button>Recent</button></h6>
                                    <h6 class="text-white text-capitalize" style="margin: 0;">
                                        <button id="add-product" style="background-color: #007bff; color: white; border: none; padding: 5px 10px; cursor: pointer;">➕ Add New Product</button>
                                    </h6>
                                </div>
