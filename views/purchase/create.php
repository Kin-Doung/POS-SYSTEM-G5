...
<script>
    ...
    function applyTranslationsToElement(element, lang) {
        ...
        element.find('select[name="category_id[]"] option[value=""]').text(translations[lang]['Select_Category']);
    }
        ...
        if (products.length === 0) {
            ...
            products.forEach((product, index) => {
                ...
                <tr class="product-row">
                    ...
                    <td>
                        <button type="button" class="removeRow" style="background: none; border: none; color: red; font-size: 15px; text-decoration: underline;" data-translate-key="Remove">
